...
export const blogTitleAndDescription = {
  news: {
    title: "Latest News, Breaking News and Political News | Crispy Read",
    description:
  ...
  automobile: {
    ...
    description:
      "Get latest news on Automobile and  Electric Vehicle at Crispy Read",
  },
  finance: {
    title: "Latest Business News India, Latest Finance News | Crispy Read",
    description:
